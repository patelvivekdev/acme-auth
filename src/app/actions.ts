...
export async function forgetPassword(formData: FormData) {
    ...
    try {
        ...
        const response = await fetch("https://api.freeapi.app/api/v1/users/forgot-password", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
...
export async function resendEmailVerification() {
    ...
    try {
        if (accessToken) {
            const response = await fetch("https://api.freeapi.app/api/v1/users/resend-email-verification", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
...
export async function changePassword(formData: FormData) {
    ...
    try {
        ...
        const response = await fetch("https://api.freeapi.app/api/v1/users/change-password", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
